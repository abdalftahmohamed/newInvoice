                                        ...
                                        <form method="POST" action="{{ route('dashboard.login.post') }}"
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input name="email" type="text" class="form-control input-lg"
                                                    id="user-name" placeholder="{{__('email')}}" tabindex="1"
                                                    {{-- required
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6 col-12 text-center text-md-right"><a
                                                        href="{{route('dashboard.password.showEmailForm')}}" class="card-link">@lang('auth.Forgot Your Password?')</a>
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-danger btn-block btn-lg"><i
                                                    class="ft-unlock"></i> @lang('dashboard.login')</button>
                                        </form>
                                    </div>
                                </div>
