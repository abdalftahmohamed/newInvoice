                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('dashboard.users.index') }}">@lang('dashboard.users')</a>
                                </li>
            ...
            <div class="content-body">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-colored-form-control">{{ __('dashboard.users') }} </h4>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <a href="{{ route('dashboard.users.create') }}" class="btn btn-danger">{{ __('dashboard.create') }}</a><br><br>
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownBreadcrumbButton">
                                                        <a class="dropdown-item"
                                                            href="{{ route('dashboard.users.edit', $user->id) }}"><i
                                                                ...
                                                                <a class="dropdown-item"
                                                            href="{{ route('dashboard.users.status', $user->id) }}"><i
                                                                class="la @if($user->status == 1) la-toggle-on @else la-toggle-off @endif"></i>{{$user->status==1?__('dashboard.unactive'):__('dashboard.active')}}</a>

                                                        <div class="dropdown-divider"></div><a class="dropdown-item"
                                                            href="javascript:void(0)"
                                                            onclick="if(confirm('Are you sure you want to delete this user?')){document.getElementById('delete-form-{{ $user->id }}').submit();} return false"><i
