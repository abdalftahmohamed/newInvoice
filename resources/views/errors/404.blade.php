                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="col-md-4 col-10 p-0">
                        <div class="card-header bg-transparent border-0">
                            ...
                            <h3 class="text-uppercase text-center">{{__('Page Not Found !')}}</h3>
                        </div>
                      ...
                      <button class="btn btn-lg btn-secondary border-grey border-lighten-1" type="button"><i class="ft-search"></i></button>
                            ...
                            <div class="row py-2">
                                <div class="col-12 col-sm-6 col-md-6">
                                    <a href="{{route('welcome')}}" class="btn btn-primary btn-block"><i class="ft-home"></i> {{__('Back to Home')}}</a>
                                </div>
                                <div class="col-12 col-sm-6 col-md-6">
