            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="{{route('dashboard.home')}}">
                        ...
                        <h3 class="brand-text">@yield('title')</h3>
                    </a>
                </li>
...
{{--                                <a class="dropdown-item" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"><i class="flag-icon flag-icon-{{ $localeCode == 'ar' ? 'eg' : 'gb' }}"></i> {{ $properties['native'] }}</a>--}}
{{--                            @endforeach--}}
                        </div>
                    </li>
